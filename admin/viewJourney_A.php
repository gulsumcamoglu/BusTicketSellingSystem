    ...
    <table id="seats" style="width: 90%">
        ...
        <tr>
            ...
            <td><?php
                ...
                $countTicket = "SELECT COUNT(*) AS totalTicket FROM ticket WHERE journeyId='$journeyId'";
                $countConnTicket = mysqli_query($conn, $countTicket);

                $countReserve = "SELECT COUNT(*) AS totalReserve FROM reservation WHERE journeyId='$journeyId'";
