...
<div class="container">
    ...
    <table id="seats" style="width: 85%">
        ...
        <tr>
            ...
            <td>
                <?php
                $query2 = "SELECT * FROM ticket WHERE journeyId='$journeyId' AND PNR='$value[5]' AND name='$value[0]'";
            ...
            <td>
                <?php
                $query2 = "SELECT * FROM ticket WHERE journeyId='$journeyId' AND PNR='$value[5]' AND seatId ='$value[4]'";
                $result2 = mysqli_query($conn, $query2);
                while ($row2 = mysqli_fetch_array($result2)) {
                    echo $row2['seatId'];
                }
