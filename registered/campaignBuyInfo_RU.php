...
?>
    ...
    <form action="#" method="POST">
        <div class="container">
            <h1>Registered User Information For Campaign Ticket</h1>
            <hr>
            ...
            <div class="cancel_signup">
                <button type="button" class="cancelbtn" style="width: 10%; border-radius: 40px"><a
                            href="campaigns_RU.php">Return</a></button>
...
if (isset($_POST['campaign_buy'])) {
    ...
    $_SESSION['genders'] = $genders;
    echo '<script> window.location.href = "campaignTicketPayment_RU.php"</script>';
    exit();
    /*
    $name = $_POST['name'];
