    ...
    <table id="seats" style="width: 85%">
        ...
        <tr>
           <td><img src="../img/bus.png" width="50px" height="50px"></td>
            ...
            <td>
                <?php
                echo "<form action='chooseSeatNoBuy_G.php' method='post'><button 
            style=\"background-color: darkgreen; width: 50%; border-radius: 20px\" value =" . $row['journeyId'] . " 
            name=\"journeyId\">Buy Ticket</button></form>";
                            ?>
            </td>
        </tr>
        <?php
